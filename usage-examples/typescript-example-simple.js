...
exports.CustomerService = exports.ApiClient = void 0;
...
class ApiClient {
    constructor(baseUrl = API_BASE_URL) {
        ...
        this.http = globalThis.require ? globalThis.require('http') : null;
        if (!this.http) {
    ...
    async updateCustomer(customerId, updateData) {
        try {
            const response = await this.makeRequest(`/customers/${customerId}`, 'PUT', updateData);
...
class CustomerService {
    ...
    async updateCustomer(customerId, updateData) {
        ...
        const mergedData = Object.assign(Object.assign({}, existingCustomer), updateData);
        return await this.client.updateCustomer(customerId, mergedData);
    }
    /**
     * Batch operations
     */
    async createMultipleCustomers(customers) {
        const results = [];
...
async function basicExample() {
    ...
    try {
        ...
        // Update customer
        const updatedData = Object.assign(Object.assign({}, sampleCustomer), { name: 'John Doe Updated' });
